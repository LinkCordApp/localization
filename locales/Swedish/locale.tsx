...
export const table: Locale = {
  ...
  dashboard_page: {
    note: {
      flag: "NOTERA",
      title:
        "Ett användarnamn krävs för att interagera med och se din profilsida!",
    },
    buttons: {
      view: "Visa sida!",
      auth: "Logga ut",
    ...
    sections: {
      ...
      use_license: {
        ...
        list_items: {
          ...
          item_2:
            "Använd materialet för något kommersiellt syfte eller för någon offentlig visning;",
          item_3:
            "Försök att reverse engineering av programvara som finns på Link Cords webbplats;",
          item_4:
  ...
  privacy_page: {
    ...
    sections: {
      your_consent: {
        title: "Ditt samtycke",
        desc1:
          "Genom att använda vår webbplats samtycker du till att vara bunden till vår integritetspolicy och",
      ...
      data_usage: {
        ...
        list_items: {
          item_1:
            "Tillhandahålla, driva och underhålla vår webbplats och våra tjänster.",
          item_2: "Förbättra, anpassa och utöka vår webbplats och tjänster.",
          item_3:
            "Förstå och analysera hur du använder och interagerar med vår webbplats.",
          item_4:
            "Utveckla och implementera nya produkter, tjänster, funktioner och funktionalitet.",
          item_5:
            "Kommunicera med dig, antingen direkt eller genom någon av våra partners.",
          item_6:
            "Skicka meddelanden, uppdateringar, varningar och påminnelser till dig.",
          item_7:
            "Hitta och förhindra alla former av bedrägerier eller sårbarheter.",
        },
      },
      log_files: {
        title: "Loggfiler",
      ...
      gdpr_policy: {
        ...
        list_items: {
          ...
          item_2:
            "Rätten att begränsa behandlingen – Du har rätt att begära att vi begränsar behandlingen av dina uppgifter under vissa förutsättningar.",
          item_3:
