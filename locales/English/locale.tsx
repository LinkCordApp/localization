...
export const table: Locale = {
  ...
  dashboard_page: {
    note: {
      flag: "NOTE",
      title:
        "A Username is required to interact with and view your profile page!",
    },
    buttons: {
      view: "View Page!",
      auth: "Logout",
    ...
    sections: {
      ...
      use_license: {
        ...
        list_items: {
          ...
          item_3:
            "Attempt to reverse engineer any software contained on Link Cord's Website;",
          item_4:
  ...
  privacy_page: {
    ...
    sections: {
      your_consent: {
        title: "Your Consent",
        desc1:
          "By using our website you are agreeing to be bound to our Privacy Policy and",
      ...
      data_usage: {
        ...
        list_items: {
          ...
          item_3:
            "Understand and Analyze how you use and interact with our Website.",
          item_4:
            "Develop and Implement new products, services, features and functionality.",
          item_5:
